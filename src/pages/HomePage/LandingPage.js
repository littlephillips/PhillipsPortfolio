        ...
        <div className="left__col">
          ...
          <div className="content">
            ...
            <ul className="social-media-icons">
              ...
              <li><a href="https://philliplabs.vercel.app/" target="_blank" rel="noopener noreferrer" aria-label="Business Site"><i className="fa-solid fa-briefcase"aria-hidden="true"></i></a></li>
            </ul>
          </div>
        </div>
